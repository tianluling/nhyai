...
router.register(r'ocr/get_driving_licence_ocr', views.OcrDrivinglicenseViewSet)
router.register(r'ocr/get_driving_permit_ocr', views.OcrVehiclelicenseViewSet)
router.register(r'ocr/get_business_licence_ocr', views.OcrBusinesslicenseViewSet)
router.register(r'ocr/get_bank_card_ocr', views.OcrBankcardViewSet)
router.register(r'ocr/get_handwritten_ocr', views.OcrHandWrittenViewSet)
router.register(r'ocr/get_plate_ocr', views.OcrVehicleplateViewSet)
router.register(r'ocr/get_business_card_ocr', views.OcrBusinessCardViewSet)
...
router.register(r'history/get_historyrecord', views.HistoryRecordViewSet)
...
ocr.register(r'get_driving_licence_ocr', views.OcrDrivinglicenseViewSet)
ocr.register(r'get_driving_permit_ocr', views.OcrVehiclelicenseViewSet)
ocr.register(r'get_business_licence_ocr', views.OcrBusinesslicenseViewSet)
ocr.register(r'get_bank_card_ocr', views.OcrBankcardViewSet)
ocr.register(r'get_handwritten_ocr', views.OcrHandWrittenViewSet)
ocr.register(r'get_plate_ocr', views.OcrVehicleplateViewSet)
ocr.register(r'get_business_card_ocr', views.OcrBusinessCardViewSet)
...
history.register(r'get_historyrecord', views.HistoryRecordViewSet)
