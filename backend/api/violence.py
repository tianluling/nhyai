...
if __name__ == '__main__':
    ...
    img_file = os.path.join(os.getcwd(), "backend", "api",
                            "yahoo", "open_nsfw", "images", "BDPAk8S.jpg")
    img_files = []

    img_file1 = os.path.join(
        os.getcwd(), "backend", "api", "yahoo", "open_nsfw", "images", "auW8xgi.jpg")
    img_file2 = os.path.join(
        os.getcwd(), "backend", "api", "yahoo", "open_nsfw", "images", "bEu0Ihd.jpg")
    img_file3 = os.path.join(
        os.getcwd(), "backend", "api", "yahoo", "open_nsfw", "images", "BgJGB9P.jpg")
    img_file4 = os.path.join(
        os.getcwd(), "backend", "api", "yahoo", "open_nsfw", "images", "BGKV2Qg.jpg")
    img_file5 = os.path.join(
        os.getcwd(), "backend", "api", "yahoo", "open_nsfw", "images", "bGpCUoU.jpg")
    img_file6 = os.path.join(
        os.getcwd(), "backend", "api", "yahoo", "open_nsfw", "images", "bh2DK9Q.jpg")
    img_file7 = os.path.join(
        os.getcwd(), "backend", "api", "yahoo", "open_nsfw", "images", "bhVEAOj.jpg")
    img_file8 = os.path.join(
        os.getcwd(), "backend", "api", "yahoo", "open_nsfw", "images", "BIaBpE7.jpg")
    img_file9 = os.path.join(
        os.getcwd(), "backend", "api", "yahoo", "open_nsfw", "images", "Bid4Z0E.jpg")
    img_file10 = os.path.join(
        os.getcwd(), "backend", "api", "yahoo", "open_nsfw", "images", "biOwhIG.jpg")

    img_file11 = os.path.join(
        os.getcwd(), "backend", "api", "yahoo", "open_nsfw", "images", "auW8xgi.jpg")
    img_file12 = os.path.join(
        os.getcwd(), "backend", "api", "yahoo", "open_nsfw", "images", "bEu0Ihd.jpg")
    img_file13 = os.path.join(
        os.getcwd(), "backend", "api", "yahoo", "open_nsfw", "images", "BgJGB9P.jpg")
    img_file14 = os.path.join(
        os.getcwd(), "backend", "api", "yahoo", "open_nsfw", "images", "BGKV2Qg.jpg")
    img_file15 = os.path.join(
        os.getcwd(), "backend", "api", "yahoo", "open_nsfw", "images", "bGpCUoU.jpg")
    img_file16 = os.path.join(
        os.getcwd(), "backend", "api", "yahoo", "open_nsfw", "images", "bh2DK9Q.jpg")
    img_file17 = os.path.join(
        os.getcwd(), "backend", "api", "yahoo", "open_nsfw", "images", "bhVEAOj.jpg")
    img_file18 = os.path.join(
        os.getcwd(), "backend", "api", "yahoo", "open_nsfw", "images", "BIaBpE7.jpg")
    img_file19 = os.path.join(
        os.getcwd(), "backend", "api", "yahoo", "open_nsfw", "images", "Bid4Z0E.jpg")
    img_file20 = os.path.join(
        os.getcwd(), "backend", "api", "yahoo", "open_nsfw", "images", "biOwhIG.jpg")
    ...
    result = myviolence.check_violences(img_files)["result"]
    t = time.time()
