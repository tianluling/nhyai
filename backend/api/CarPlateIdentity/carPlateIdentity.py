...
if __name__ == '__main__':
    ...
    char_w,char_h = 20,20
    plate_model_path = os.path.abspath('backend/api/preprocess/CarPlateIdentity/code/carIdentityData/model/plate_recongnize/model.ckpt-510.meta')
    char_model_path = os.path.abspath('backend/api/preprocess/CarPlateIdentity/code/carIdentityData/model/char_recongnize/model.ckpt-550.meta')
    img_path = os.path.abspath('backend/api/preprocess/CarPlateIdentity/code/carIdentityData/images/10.jpg')
